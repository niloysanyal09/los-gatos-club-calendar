...
export function demoEvents(): RawEvent[] {
  return [
    // — Clubs & sessions (real local venues with public schedules) —
    {
      lane: "clubs",
      category: "yoga",
      title: "Evening Vinyasa Flow — YogaSix Palo Alto",
      description: "Drop-ins welcome; class schedule and booking at the link.",
      venueName: "YogaSix Palo Alto",
      venueAddress: "855 El Camino Real, Palo Alto, CA",
      distanceMiles: 3.2,
      cost: "Drop-in; see schedule",
      url: "https://www.yogasix.com/location/palo-alto",
      source: "demo",
      ...pt(2026, 7, 27, 18, 0, 1),
    },
    {
    ...
    },
    {
      ...
      distanceMiles: 4.9,
      cost: "Free",
      url: "https://allevents.in/redwood-city/concerts",
      source: "demo",
